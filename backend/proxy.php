...
$valid_requests = array(
    'https://catalogue-bm.geneve.ch',
    'https://catalogue-bm.geneve.ch/in/rest/api/search'
);
...
csajax_debug_message('HELLO2');
csajax_debug_message($request_params);
...
csajax_debug_message($p_request_url);
